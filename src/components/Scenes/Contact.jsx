...
const Contact = ({ setSelectedPage }) => {
  ...
  return (
    <div
      id="contact"
      className="py-[100px] flex flex-col pb-20  w-full max-w-[800px] mx-auto gap-y-6 sm:gap-y-7 lg:gap-y-8 items-center">
      <motion.div
      ...
      <motion.div
        ...
        <motion.h1
          ...
          Dont be a stranger!{" "}
          <WavingHand size={"h-[30px] sm:h-9 md:h-12 lg:h-[60px]"} />
        </motion.h1>
        <motion.p
